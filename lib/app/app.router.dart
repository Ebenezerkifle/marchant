...
import 'package:marchant/models/category_model.dart' as _i29;
import 'package:marchant/models/order_model.dart' as _i28;
import 'package:marchant/models/product_model.dart' as _i27;
...
import 'package:marchant/ui/views/page_builder/page_builder_view.dart' as _i22;
import 'package:marchant/ui/views/profile/mydetail/mydetail_view.dart' as _i20;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i25.NoConnectionView: (data) {
      return _i26.MaterialPageRoute<dynamic>(
        builder: (context) => const _i25.NoConnectionView(),
        settings: data,
      );
    },
  };
...
class SubCategoryListViewArguments {
  ...
  final List<_i29.Category> subCategories;
...
class PageBuilderViewArguments {
  const PageBuilderViewArguments({
    required this.product,
    this.key,
  });
  ...
  @override
  bool operator ==(covariant PageBuilderViewArguments other) {
    if (identical(this, other)) return true;
...
extension NavigatorStateExtension on _i30.NavigationService {
  ...
  Future<dynamic> navigateToSubCategoryListView({
    _i26.Key? key,
    required List<_i29.Category> subCategories,
  ...
  Future<dynamic> navigateToMydetailView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> replaceWithMydetailView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
